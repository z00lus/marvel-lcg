...
class GameServer(GameServerFiles, GameServerHTML, GameServerGet, GameServerNewGame, GameServerDeckEditor, GameServerMarvelCdb, GameServerCampaignProgress, GameServerProxy, GameServerGameHistory, GameServerAgent, GameServerSocket, GameServerSync):
